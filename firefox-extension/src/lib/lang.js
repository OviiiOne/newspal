...
const I18N = {
  es: {
    ...
    bg_gt_recovered: 'Traductor: Google vuelve a responder',
    bg_gt_network: 'sin conexión',
    bg_gt_ratelimit: 'límite de peticiones, HTTP 429',
    bg_gt_http: 'HTTP {status}',
    bg_gt_blocked: 'devuelve una página de bloqueo en vez de la traducción',
    bg_gt_shape: 'respuesta con formato inesperado',
    ...
    ac_gladia_socket_failed: 'No se pudo abrir la conexión en directo con Gladia tras varios intentos (código {code}). Detén y vuelve a empezar; si se repite, puede ser la red o la propia Gladia.',
  ...
  en: {
    ...
    bg_gt_recovered: 'Translator: Google is responding again',
    bg_gt_network: 'no connection',
    bg_gt_ratelimit: 'rate limit, HTTP 429',
    bg_gt_http: 'HTTP {status}',
    bg_gt_blocked: 'returns a block page instead of a translation',
    bg_gt_shape: 'unexpected response format',
    ...
    ac_gladia_socket_failed: 'Could not open the live connection to Gladia after several attempts (code {code}). Stop and start again; if it keeps happening, it may be the network or Gladia itself.',
